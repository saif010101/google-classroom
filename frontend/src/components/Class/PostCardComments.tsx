...
export const PostCardComments = ({ post_id }: PostCardCommentsProps) => {
    ...
    return (
        <div className='p-5 border-t-1 border-gray-300'>
            ...
            {doesDataExists() && !commentListActive && <CommentBox comment_id={data[0].comment_id} author_id={data[0].user_id} author={data[0].name} content={data[0].content} date={data[0].posted_at} />}
